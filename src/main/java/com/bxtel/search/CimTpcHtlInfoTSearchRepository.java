  ...
  analysis:
    analyzer:
      ...
      ik_smart:
        ...
        use_smart:true
 */
public interface CimTpcHtlInfoTSearchRepository extends ElasticsearchRepository<CimTpcHtlInfoT, String>{
//	 
//	 @Query("{\"bool\" : {\"must\" : {\"field\" : {\"name\" : \"?0\"}}}}")
//	 Page<Sms> findByStatus(String status,Pageable pageable);
//	
	
	@Query("{\"bool\" : {\"must\" : {\"field\" : {\"companyId\" : \":companyId\"}}}}")
	Page<CimTpcHtlInfoT> findByCompanyId(@Param(value = "companyId") String status,Pageable pageable);
