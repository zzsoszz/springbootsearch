...
<html>
<head>
	<title>编辑com.bxtel.model.Sms</title>
...
<form method="post" action="doupdate.do" method="post">  
	...
	<table>
			 ...
			 <tr>
				...
				<td><input name="mobile"  class="${model.mobile}" value="${model.mobile}" /></td>
			</tr>
			 <tr>
				<td><label for="content">content</label></td>
				<td><input name="content"  class="${model.content}" value="${model.content}" /></td>
			</tr>
			 <tr>
				<td><label for="msgid">msgid</label></td>
				<td><input name="msgid"  class="${model.msgid}" value="${model.msgid}" /></td>
			</tr>
			 <tr>
