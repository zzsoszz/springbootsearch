...
<html>
    <head>
        ...
        <script type="text/javascript">
    	   ...
    	   function sys_add()
		   {
		   		document.forms["form1"].action="${ctx}/com/bxtel/model/controller/.sms/showadd.do";
		   ...
		   function sys_list()
		   {
		   		document.forms["form1"].action="${ctx}/com/bxtel/model/controller/.sms/showlist.do";
		   		document.forms["form1"].target="list_iframe";
		   		document.forms["form1"].submit();
		   }
		</script>
    ...
    <body>
		<div class="tabBlock">
			...
			<form id="form1" action="${ctx}/com/bxtel/model/controller/.sms/showlist.do" target="list_iframe">
							...
							<table id="table1" >
							    ...
							    <tbody>
											...
											<tr>
									            ...
									            <td>
									                <input id=".Sms" name=".Sms" class="inputText" type="text" maxlength="40"/> 
									            </td>
									        </tr>
											<tr>
									            <th  width="20%">
